---
title: "FY18_Search_November2017"
...
```{r}
LeadsUploaded <- read.csv("C:/Users/christine.iyer/Box/Search/FY18_Search/Search_Oct_2017/Search_October2017_Downloads.csv", header = T, stringsAsFactors = F)
...
Inquiries <- LeadsUploaded %>% filter(Student.Stage != "Lead") %>% mutate(ApplicationStatus =
